            ...
            <div className='w-full py-5'>
              <div className='w-full block 800px:flex'>
                ...
                <div className='w-full 800px:w-[50%]'>
                  <img src={`${backend_url}${data?.images && data?.images[select]}`} alt='' className='w-[75%] h-[60%] mt-10'/>
                ...
                <div className='w-full 800px:w-[50%] pt-5'>
                  ...
                  <div className='flex items-center pt-8'>
                    ...
                    <div className='pr-8' >
                      <Link to={`/shop/preview/${data.shop._id}`}>
                        <h3 className={`${styles.shop_name} pb-1 pt-1 cursor-pointer`}>{data.shop.name}</h3>
                      </Link>
                    ...
                    <div className={`${styles.button} bg-[#6443d1] !rounded !h-11 mt-4`}
          ...
          <div className='w-full  min-h-[40vh] flex flex-col items-center py-3 overflow-y-scroll'>
            {
              data && data.reviews.map((item,index) => (
                <div className='w-full flex my-2'>
                  <img src={`${backend_url}${item.user.avatar}`} alt='review' className='w-[50px] h-[50px] rounded-full'/>
                  <div className='pl-3'>
